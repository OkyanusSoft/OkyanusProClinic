...
const SECTIONS: GSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "سجّل الشكوى والتشخيص، ثم حدّد الأسنان من الخريطة واختر حالة كل سن: سليم، قلع، حشوة، سحب عصب (مع رسم عدد القنوات)، تركيب، تقويم، تاج/زراعة، أو مفقود.",
      "أضف الإجراءات (تُضاف للفاتورة لحظياً) واربطها بمرحلة الجلسات: الأولى، الثانية، الثالثة… للعلاج متعدد الزيارات.",
    ...
    features: [
      ...
      "خريطة الأسنان تتبدل حسب العمر: لبنية A–E للأطفال ودائمة FDI للبالغين، مع اختيار متعدد",
      "حالات السن الثماني مع رسم قنوات العصب ونوع الحشوة والتركيب والتقويم",
      "جدول مراحل الجلسات متعدد الزيارات مع التاريخ والملاحظات والعودات المرتبطة",
      "تغييرات الأسنان «معلّقة» وتُثبَّت عند الخروج فقط",
      "مريض غير مجدول؟ زر خاص لإدخاله فوراً",
      "افتح أي جلسة مكتملة سابقة للقراءة فقط ومراجعة ما تم فيها",
    ],
    tips: [
  ...
  },
  {
    ...
    steps: [
      ...
      "حقل المدينة ذكي: اكتب مدينة غير موجودة وستظهر أيقونة زائد لإضافتها فوراً للقائمة.",
      "ابحث بالاسم أو الجوال، أو صفِّ: عليه مستحقات / جدد / لديه تسوس.",
      "اضغط على أي صف لفتح «درج الملف» الكامل.",
      "حدّث الأسنان من المخطط — يتبدل تلقائياً: لبنية A–E للأطفال ودائمة FDI للبالغين.",
      "من الدرج: اطبع كرت المريض، احجز موعداً، جدول عودة، أو أنشئ روشتة بضغطة.",
    ],
    features: [
      "مخطط أسنان تشريحي رباعي يتبدل حسب عمر المريض (أطفال/بالغون)",
      "مؤشر صحة الفم نسبةً مئوية مع عدّاد لكل حالة",
      "كرت المريض المطبوع على A4 بوجهين (بيانات + خريطة الأسنان)",
  ...
  },
  {
    ...
    intro: "تتبع المواد الطبية وغير الطبية مع فئات الأصناف وتنبيهات النفاد والصلاحية.",
    icon: <IconBox className="w-5 h-5" />,
    tint: "bg-amber-soft text-[#a06410]",
    steps: [
      "من «فئات الأصناف»: أنشئ فئة أو أعد تسمية فئة — تنعكس فوراً في قوائم الأصناف.",
      "من «بيانات الأصناف»: أضف صنفاً باسمه وفئته ووحدته وحدّه الأدنى وتكلفة الوحدة وتاريخ الانتهاء.",
      ...
      "اطبع تقرير المخزون من مركز التقارير.",
    ],
    features: [
      "فئات الأصناف قابلة للإضافة وإعادة التسمية وإعادة التوزيع التلقائي",
      "مقياس مستوى ملوّن لكل صنف (أخضر/كهرماني/أحمر)",
      "تتبع تواريخ الصلاحية مع تنبيه الاقتراب",
      "تقرير مخزون شامل في مركز التقارير مع التصدير والطباعة",
    ],
    tips: [
  ...
  },
  {
    ...
    intro: "خدمات العيادة وفئاتها وأسعارها — ما يظهر في الحجز والفواتير يبدأ من هنا.",
    icon: <IconSpark className="w-5 h-5" />,
    tint: "bg-jade-soft text-jade-deep",
    steps: [
      "من «بيانات الخدمات»: أضف خدمة باسمها وفئتها ومدتها وسعرها ولونها المميز، وأوقفها بمفتاح «متاحة».",
      "من «فئات الخدمات»: أنشئ فئة جديدة أو أعد تسمية فئة — تنعكس فوراً في قوائم الاختيار.",
      "من «قائمة الأسعار»: اطبع قائمة أسعار جاهزة على A4 أو عدّل أي سعر بالضغط عليه ثم Enter.",
      "صفِّ بالفئات: تشخيص، وقاية، علاج، تجميل، جراحة، تعويضات، تقويم.",
    ],
    features: [
      "فئات الخدمات قابلة للإضافة وإعادة التسمية وإعادة التوزيع التلقائي",
      "اللون المميز يظهر في بطاقات المواعيد وتقارير الجلسات",
      "قائمة الأسعار المطبوعة تحمل ترويسة العيادة",
  ...
  },
  {
    id: "reports",
    title: "مركز التقارير",
    intro: "ثمانية تقارير احترافية جاهزة للطباعة والتصدير.",
    icon: <IconTrendUp className="w-5 h-5" />,
    tint: "bg-sky-soft text-sky",
    steps: [
      "اختر التقرير من البطاقات العلوية: عام، مرضى، مالي، أطباء، خدمات، مصروفات، عودات، مخزون.",
      "عدّل الفترة الزمنية إن كانت متاحة (شهري/ربع سنوي).",
      "اطبع بضغطة — ترويسة العيادة وتوقيع الطبيب جاهزان على الورقة.",
      "اطبع أي جلسة مكتملة كتقرير سريري كامل من «الجلسات المكتملة».",
      "صدّر CSV للبيانات الخام.",
    ],
    features: [
      "تقرير مرضى شامل بأرقام الجوال والمستحقات وحالة الفم",
      "تقرير مخزون: الأرصدة، المنخفض، القيمة الإجمالية، الصلاحيات القريبة",
      "تقرير أطباء: مكتمل/قادم/ملغى/لم يحضر مع نسب الإنجاز",
      "تقرير عودات: معلقة/متأخرة/نسبة الالتزام",
      "طباعة الجلسات المكتملة بتقرير العمل والإجراءات والفاتورة",
      "رسوم أعمدة وخطوط متحركة — كل تقرير يعكس نطاق صلاحياتك",
    ],
  ...
  },
  {
    ...
    tint: "bg-jade-soft text-jade-deep",
    steps: [
      "أضف طبيباً باسمه وتخصصه ولونه المميز — حقل التخصص ذكي يضيف أي تخصص جديد فوراً.",
      "أضف موظفاً مسانداً (سكرتارية، تمريض، فني…) بدوره ومسمى وظيفي يُضاف للحظياً.",
      "فعّل/أوقف أي عضو بمفتاح واحد.",
      "اربط حساب الدخول بالطبيب من شاشة المستخدمين ليُقيَّد بمرضاه.",
    ],
    features: [
      "حقول ذكية بقائمة اقتراحات للتخصصات الطبية والمسميات الوظيفية مع أيقونة زائد للإضافة الفورية",
  ...
  },
  {
    ...
    intro: "هوية العيادة، الدوام، الفوترة، قاعدة البيانات، والبيانات — تسري على النظام كله.",
    ...
    steps: [
      ...
      "قاعدة البيانات: أدخل بيانات اتصال MySQL، اضغط «اختبار الاتصال» ثم «مزامنة الآن».",
      "البيانات: صدّر نسخة احتياطية، استورد، أو احذف كل البيانات من «منطقة الخطر».",
    ],
    features: [
      "معاينة حية لترويسة الوثائق ورأس الفاتورة قبل الحفظ",
      "قسم قاعدة البيانات مع تشخيص متعدد المراحل يعرض خطأ MySQL الحقيقي",
  ...
  },
  {
    id: "preferences",
    title: "التفضيلات",
    intro: "مظهر النظام وشخصيته — تُحفَظ لكل جهاز وتُطبَّق على النظام كله.",
    icon: <IconSettings className="w-5 h-5" />,
    tint: "bg-sky-soft text-sky",
    steps: [
      "اختر النمط: فاتح، داكن، أو تلقائي (يتبع جهازك).",
      "انتقِ لوناً مميزاً من ٦ لوحات — يعيد تلوين النظام كله فوراً.",
      "اضبط حجم الخط والترقيم العربي ومدة الإشعارات.",
    ],
    features: [
      "معاينة حية لكل تغيير قبل الحفظ",
      "الوضع الداكن يعيد تلوين كل الأسطح والبطاقات والحقول",
      "تفضيلاتك خاصة بجهازك ولا تمسّ بقية المستخدمين",
    ],
    tips: ["جرّب الترقيم العربي (١٢٣) لتظهر الأرقام والتواريخ بالأرقام المشرقية."],
  },
  {
    id: "monitor",
    title: "مراقبة النشاط",
    intro: "عين المدير على كل الأجهزة — من أدخل ماذا ومتى ومن أي جهاز.",
    icon: <IconShield className="w-5 h-5" />,
    tint: "bg-pine text-[#7fe0d4]",
    steps: [
      "افتح الشاشة من قائمة إعدادات النظام — تظهر آخر عمليات كل الموظفين ببث حي.",
      "صفِّ بموظف معيّن أو بفئة (المرضى، المواعيد، المالية، المخزون…) أو ابحث نصياً.",
      "راجع مؤشرات الأعلى: عمليات اليوم، الموظفون النشطون، أجهزة الشبكة.",
    ],
    features: [
      "بث مباشر يتحدث كل ٥ ثوانٍ",
      "رسم توزيع النشاط لآخر ١٢ ساعة",
      "قائمة أجهزة الشبكة مع حالة كل جهاز وآخر مستخدم",
      "صلاحية المراقبة للمدير فقط",
    ],
    tips: ["سمِّ كل جهاز من الإعدادات (مثل: جهاز الاستقبال) ليظهر باسمه هنا."],
  },
];
...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: "السكرتارية أدخلت مريضاً — متى يراه الدكتور؟",
    a: "خلال ثوانٍ. النظام يزامن بالدمج المركزي: كل جهاز يستطلع القاعدة كل ٤ ثوانٍ ويدمج الجديد، فيظهر إدخال أي جهاز لبقية الأجهزة لحظياً دون حذف شيء.",
  },
  {
    q: "هل يعمل النظام بدون إنترنت؟",
    a: "نعم بالكامل. الخطوط وكل الأصول مضمّنة في الحزمة، فإن انقطع الاتصال يعمل النظام على التخزين المحلي ثم يزامن تلقائياً عند عودة الخادم.",
  },
  {
    q: "كيف أراقب عمل الموظفين على الأجهزة؟",
    a: "من شاشة «مراقبة النشاط» (للمدير): كل إضافة وتعديل وحذف تُسجَّل باسم الموظف وجهازه، مع بث حي وفلاتر ورسم توزيع وقائمة أجهزة الشبكة.",
  },
];
      ...
      <div className="grid lg:grid-cols-[270px_1fr] gap-6 items-start">
        ...
        <div className="space-y-5 min-w-0">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-2 pt-1 pb-4">
            ...
            <span className="chip bg-white border border-line text-soft">الدليل · الإصدار 4.0 · محدّث {new Intl.DateTimeFormat("ar-EG-u-nu-latn", { month: "long", year: "numeric" }).format(new Date())}</span>
          </div>
        </div>
      </div>
    </div>

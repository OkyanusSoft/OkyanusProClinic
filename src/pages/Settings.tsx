...
const CHANGELOG: { v: string; date: string; current?: boolean; items: { tag: "جديد" | "تحسين" | "إصلاح"; text: string }[] }[] = [
  ...
  },
  {
    ...
    date: "يونيو 2026",
    items: [
      { tag: "جديد", text: "خريطة أسنان بأسنان تشريحية حقيقية (تاج بشرفات + جذور وخط إطباق) بدلاً من المربعات، وأرقام FDI كبيرة بهالة تباين" },
      { tag: "جديد", text: "قسم «حالة السن» على يمين الخريطة بثماني حالات (سليم/تسوس/حشوة/عصب/تركيب/تقويم/تاج/مفقود) تُحدّث السّن لحظياً" },
      { tag: "جديد", text: "رسم تفاصيل الحالات على السن نفسه: بقعة التسوس، حشوة العصب، حاصرة التقويم والسلك، إطار التاج، وعلامة المفقود" },
      { tag: "جديد", text: "طباعة الملف الطبي الكامل للمريض وكشف مواعيد اليوم مع المتابعات المستحقة على A4" },
      { tag: "تحسين", text: "مؤشر صحة الفم أسفل الخريطة بشريط أفقي: نسبة مئوية ملوّنة + شريط تقدم + عدّادات الحالات السبع" },
      { tag: "تحسين", text: "ترقية رقم الإصدار إلى 2.7" },
    ],
  },
  {
    v: "2.6",
